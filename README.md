...
- [CI builds](https://ci.infra.status.im/job/website/job/guide.nomos.tech/) `master` and pushes to `deploy-master` branch, which is hosted at <https://guide.nomos.tech//>.
- [CI builds](https://ci.infra.status.im/job/website/job/dev-guide.nomos.tech/) `develop` and pushes to `deploy-develop` branch, which is hosted at <https://dev-guide.nomos.tech//>.
