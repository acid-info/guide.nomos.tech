...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    title="Mark"
    forceDownload
    previewSrc="/logo/Mark/PREVIEW-Nomos-Mark.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Mark/Nomos-Mark.png"
      },
      {
        title: "SVG",
        src: "/logo/Mark/Nomos-Mark.svg"
      }
    ]}
  />
</div>
...
<div style={{display: "flex", gap: "16px"}}>
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/PREVIEW-Nomos-Vertical lockup-Black.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Nomos-Vertical lockup-Black.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Nomos-Vertical lockup-Black.svg"
      }
    ]}
  />
  ...
  <AssetCard
    ...
    forceDownload
    previewSrc="/logo/Vertical lockup/PREVIEW-Nomos-Vertical lockup-White.png"
    downloadable={[
      {
        title: "PNG",
        src: "/logo/Vertical lockup/Nomos-Vertical lockup-White.png"
      },
      {
        title: "SVG",
        src: "/logo/Vertical lockup/Nomos-Vertical lockup-White.svg"
      }
    ]}
  />
</div>
